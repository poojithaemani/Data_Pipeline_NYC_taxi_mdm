...
CALL sp_upsert_golden_zone(:test_location_id, 'TestBorough', 'TestZone', 'TestService', :v1, NULL, NULL);
...
CALL sp_upsert_golden_zone(:test_location_id, 'TestBorough', 'TestZone Updated', 'TestService', :v2, NULL, NULL);
SELECT golden_zone_row_id, location_id, borough, zone, service_zone, record_hash, version, is_current, effective_date, end_date
